// Universal Piece Moderation Bot - Database Handler (Complete Schema Repair)
...
const db = {
    ...
    ensureTables: async () => {
        ...
        // This list covers every interaction your code might have.
        const allColumns = [
            ...
            { name: 'logmessageid', type: 'TEXT' },  // <--- The one causing your latest error
        ...
        for (const col of allColumns) {
            try {
                ...
                // If error is not "Duplicate column", log it.
